    ...
    def viewLayers(self):
        ...
        for i, l in enumerate(layers):
            ...
            try:
                ...
                fig = plt.figure(figsize=(s[2],
                                          s[3]))  # width, height in inches
                channel = 0
                filter = 0
                ...
                try:
                    fig = plt.figure(
                        figsize=(3, len(x)))  # width, height in inches
                    for i in range(len(x)):
                        ...
                        if i == 0:
                            ...
                            clim = (0, 2)
                        sub.imshow(
                            [x[i]], cmap='coolwarm', clim=clim, aspect="auto")
                    ...
                    try:
                        fig = plt.figure(
                            figsize=(3, 3))  # width, height in inches
                        sub = fig.add_subplot(1, 1, 1)
                        sub.imshow(
                            x[0], cmap='coolwarm', clim=(-1, 1), aspect="auto")
